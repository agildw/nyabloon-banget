				...
				<?php endif ?>
					...
					<div class="row gy-3 overflow-hidden">
						...
						<div class="form-floating mb-3">
							<input type="email" class="form-control bg-white" name="email" id="email" placeholder="name@example.com" required value="<?= set_value('email') ?>">
						...
						<div class="col-12">
						<div class="form-floating mb-3">
							<input type="password" class="form-control bg-white" name="password" id="password" value="" placeholder="Password" required value="<?= set_value('password') ?>">
