         ...
         <div class=" col-12">
            <div class="card">
               ...
               <div class="card-content">
                  <div class="card-body">
                     <form class="form form-horizontal" action="<?= base_url('admin/add_product_action') ?>" method="post">
                        <div class="form-body">
                           <div class="row">
                              <div class="col-md-4">
                              ...
                              <div class="col-md-8 form-group">
                                 <textarea type="description" id="description" class="form-control" name="description" placeholder="Description" style="padding: 10px; margin: 0; height: 150px;"></textarea>
                              </div>
                              </div>
