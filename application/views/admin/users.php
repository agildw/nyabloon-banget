...
<head>
    ...
    <link rel="stylesheet" crossorigin href="<?= base_url('assets/admin/compiled/css/iconly.css'); ?>">
    <base href="<?= base_url(); ?>">
</head>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <a href="<?= base_url('admin/users/add') ?>" class="btn btn-primary mb-3">Add User</a> 
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-lg table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="cursor: pointer;" onclick="window.location='<?= base_url('admin/users/') . $user->id ?>'">
                                            <td><?= $user->name ?></td>
                                            <td><?= $user->email ?></td>
                                            <td><?= $user->role ?></td>
