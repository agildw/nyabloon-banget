			...
			<section class="chooseUs-sec container pt-xl-22 pt-lg-20 pt-md-16 pt-10 pb-xl-12 pb-md-7 pb-2">
				<div class="row">
					...
					<div class="col-12 col-lg-6 pr-4">
						...
						<p class="mb-xl-14 mb-lg-10">LNyabloon Banget menyediakan berbagai pilihan pakaian sablon berkualitas dengan desain yang menarik dan bahan yang nyaman. Kami selalu berkomitmen untuk memberikan produk terbaik. <a href="javascript:void(0);" class="btnMore"><i>Learn More</i></a></p>
						<!-- chooseList -->
